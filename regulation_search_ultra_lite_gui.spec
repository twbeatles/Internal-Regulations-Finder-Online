...
excludes = [
    ...
    # === GUI 프레임워크 (PyQt6는 제외하지 않음) ===
    'tkinter', 'tk', '_tkinter',
    'PyQt5', 'PySide2', 'PySide6',  # PyQt6 제외됨
    'wx', 'wxPython',
...
# ============================================================================
a = Analysis(
    ['server_gui.py'],  # ⭐ GUI 엔트리포인트
    pathex=[project_dir],
    binaries=pyqt_binaries,  # PyQt6 바이너리 포함
    datas=datas,
